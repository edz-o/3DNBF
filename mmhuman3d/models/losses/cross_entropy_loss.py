...
@weighted_loss
def cross_entropy_loss(pred, target, ignore_index=-1):
    if len(pred.shape) == 4:
    ...
    loss = F.cross_entropy(pred, target, ignore_index=ignore_index, reduction='none')
...
class CrossEntropyLoss(nn.Module):
    ...
    def forward(self,
        ...
        loss = loss_weight * cross_entropy_loss(
