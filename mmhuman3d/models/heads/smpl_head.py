...
from mmhuman3d.utils.geometry import rot6d_to_rotmat_4dhuman, rot6d_to_rotmat
from pytorch3d.transforms import axis_angle_to_matrix
from mmhuman3d.models.components.pose_transformer import TransformerDecoder
...
class SMPLTransformerDecoderHead(BaseModule):
    """ Cross-attention based SMPL Transformer decoder
    """

    def __init__(self, cfg, init_cfg=None):
        super().__init__()
        self.cfg = cfg
        ...
        transformer_args.update(dict(cfg.TRANSFORMER_DECODER))
    ...
    def forward(self, x, **kwargs):
        ...
        pred_betas_list = []
        pred_cam_list = []
        for i in range(self.cfg.get('IEF_ITERS', 1)):
