                    ...
                    for j, vid_i in tqdm(enumerate(vid_list), desc='vid list'):
                        ...
                        if self.extract_img:
                            ...
                            while 1:
                                ...
                                # save image
                                imgname_src = os.path.abspath(os.path.join(dataset_path, 'mpi_inf_3dhp_train_set', 'S' + str(user_i),
                                            'Seq' + str(seq_i), 'images', f'S{user_i}_Seq{seq_i}_V{vid_i}', f'img_S{user_i}_Seq{seq_i}_V{vid_i}_{frame:06d}.jpg'))
                                # mpi_inf_3dhp_train_set/S1/Seq1/images/S1_Seq1_V0/img_S1_Seq1_V0_000001.jpg
                                # os.system(f'ln -s {imgname_src} {imgname}')
