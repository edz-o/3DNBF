...
registrant = dict(
    ...
    # optimizer=dict(type='RMSprop', lr=0.02),
    # optimizer=dict(type='Adagrad', lr=0.02),
    ...
    keypoints2d_loss=dict(
        type='KeypointMSELoss', loss_weight=1 * 1e-2, reduction='sum', sigma=100
    ),
